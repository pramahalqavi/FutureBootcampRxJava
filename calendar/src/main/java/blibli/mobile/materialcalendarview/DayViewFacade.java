...
public class DayViewFacade {
  ...
  /**
   * Set a custom selection drawable TODO: define states that can/should be used in
   * StateListDrawables
   *
  ...
  public void addSpan(@NonNull Object span, Integer startIndex, Integer endIndex) {
    if (spans != null) {
      this.spans.add(new Span(span, startIndex, endIndex));
      isDecorated = true;
    }
  }
   ...
   * </p>
   * <p>
   * Note, passing true here will <b>not</b> override minimum and maximum dates, if set. This will
   * only re-enable disabled dates.
   * </p>
   *
  ...
  static class Span {
    ...
    public Span(Object span, Integer startIndex, Integer endIndex) {
