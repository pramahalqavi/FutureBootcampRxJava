...
import blibli.mobile.materialcalendarview.DateRangeIndex;
import blibli.mobile.materialcalendarview.WeekPagerAdapter;
...
public class WeeklyRangeIndexTest {
  ...
  public void shouldReturnCorrectFirstDayForDisplayedWeek() throws Exception {
    DateRangeIndex systemUnderTest =
        new WeekPagerAdapter.Weekly(TEST_MIN, TEST_MAX, FIRST_DAY_OF_WEEK);
